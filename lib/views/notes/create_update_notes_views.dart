...
import 'package:flutter_course_project/utilities/generics/get_arguments.dart';
import 'package:share_plus/share_plus.dart';

class CreateUpdateNoteViews extends StatefulWidget {
  const CreateUpdateNoteViews({Key? key}) : super(key: key);

  @override
  _CreateUpdateNoteViewsState createState() => _CreateUpdateNoteViewsState();
}

class _CreateUpdateNoteViewsState extends State<CreateUpdateNoteViews> {
  CloudNote? _note;
